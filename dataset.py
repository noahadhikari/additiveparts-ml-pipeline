...
class BinvoxDataset(Dataset):
    ...
    def __init__(self, ratings_csv, id_data_csv):
        ...
        self.binvox_labels = self.binvox_labels[self.binvox_labels["full_binvox_path"].apply(
...
class BinvoxManualLabelDataset(BinvoxDataset):
    ...
    def __init__(self, ratings_csv, id_data_csv):
        ...
        # drop nonexistent manual scores
        self.binvox_labels = self.binvox_labels.dropna(subset=['score'])
        # drop manual scores equal to -100
        self.binvox_labels = self.binvox_labels[self.binvox_labels["score"] !=
                                                -100]
